...
``
   ...
   //get all products
   async findAll(queryDto:QueryProductDto):Promise<{data:ProductResponseDto[],
    meta:{total:number,page:number,limit:number,totalPage:number}}>{

   const {category , isActive ,limit , search , sortBy , sortOrder  , minPrice , maxPrice}=queryDto;
