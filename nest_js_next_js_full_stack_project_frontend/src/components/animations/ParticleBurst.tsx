  ...
  useEffect(() => {
    ...
    const init = () => {
      ...
      for (let i = 0; i < 200; i++) {
        ...
        particles[i].distance = Math.random() * 400;
      ...
      <div className="absolute top-8 right-8 z-50">
        <div className="relative">
          <button 
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-full border text-sm font-semibold transition-all backdrop-blur-md shadow-lg ${
              isLight 
          ...
          {isDropdownOpen && (
            <div className={`absolute top-full right-0 mt-2 w-48 rounded-2xl border shadow-xl overflow-hidden backdrop-blur-xl animate-in fade-in slide-in-from-top-2 ${
              isLight 
